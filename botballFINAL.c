...
int armservosecond = 550;
int wristservo = 3;
int wristservostart = 1448;
int wristservosecond = 416;
int motorbackclick = -2475;
int motorturnclick = 1050;
int cranedownamount = 1156;
int craneupamount = 530;
int craneupamountsecond = 500;
int startpos = 205;
...
void crane_up(int craneupamount)
{
    enable_servos();
    while(startpos > craneupamount)
    {
        set_servo_position(armservo, startpos);
        msleep(50);
        startpos = startpos - 25;
